...
@section('content')
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('products.restore', [$soft->id]) }}"
                            onclick="return confirm('Bạn có muốn khôi phục không?');" class="btn btn-warning">Restore
                           </a>
                        <a href="{{ route('products.deleteforever', [$soft->id]) }}"
                            onclick="return confirm('Bạn có chắc chắn xóa vĩnh viễn không?');" class="btn btn-secondary">
    ...
    <a href="{{ route('products.index') }}" class="btn btn-info">Back</a> <br>
@endsection
